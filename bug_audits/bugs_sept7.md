...
| BUG-038 | P2 | Advertised usage date-range controls are absent | Fixed | `5728294` | Component regressions cover inclusive bounds, empty and reversed ranges, zero and missing days, refresh persistence, reset, synchronized views, and complete-period comparisons. |
